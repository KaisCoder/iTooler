 ...
 * @since 2018/8/7.
 */
public class iWheelView<T> extends View implements Runnable {
...
//    public static final int DIVIDER_TYPE_WRAP = 1;
    ...
    public iWheelView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public iWheelView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    ...
    private void draw3DText(Canvas canvas, String text, float rotateX, float offsetY, float offsetZ, int centerToBaselineY) {
        ...
        //根据弯曲（3d）对齐方式设置系数
        if (mCurvedArcDirection == iRollerUtil.CURVED_ARC_DIRECTION_LEFT) {
            centerX = mCenterX * (1 + mCurvedArcDirectionFactor);
        } else if (mCurvedArcDirection == iRollerUtil.CURVED_ARC_DIRECTION_RIGHT) {
            centerX = mCenterX * (1 - mCurvedArcDirectionFactor);
        }
    ...
    public void setTextSize(float textSize, boolean isSp) {
        ...
        mTextSize = isSp ? iRollerUtil.sp2px(textSize) : textSize;
     ...
     */
    public void setTextAlign(@iRollerUtil.TextAlign int textAlign) {
    ...
    public void setLineSpacing(float lineSpacing, boolean isDp) {
        ...
        mLineSpacing = isDp ? iRollerUtil.dp2px(lineSpacing) : lineSpacing;
     ...
     */
    public void setDividerType(@iRollerUtil.DividerType int dividerType) {
    ...
    public void setDividerPaddingForWrap(float dividerPaddingForWrap, boolean isDp) {
        ...
        mDividerPaddingForWrap = isDp ? iRollerUtil.dp2px(dividerPaddingForWrap) : dividerPaddingForWrap;
     ...
     */
    public void setCurvedArcDirection(@iRollerUtil.CurvedArcDirection int curvedArcDirection) {
