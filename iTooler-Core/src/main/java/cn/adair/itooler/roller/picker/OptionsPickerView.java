 ...
 * @since 2018/8/21.
 */
public class OptionsPickerView<T> extends LinearLayout implements OnItemSelectedListener<T> {
    ...
    //WheelView
    private iWheelView<T> mOptionsWv1;
    private iWheelView<T> mOptionsWv2;
    private iWheelView<T> mOptionsWv3;
    ...
    private void initViews(Context context) {
        ...
        mOptionsWv1 = new iWheelView<>(context);
        mOptionsWv1.setId(ID_OPTIONS_WV_1);
        mOptionsWv2 = new iWheelView<>(context);
        mOptionsWv2.setId(ID_OPTIONS_WV_2);
        mOptionsWv3 = new iWheelView<>(context);
     ...
     */
    private void setDataOrGone(List<T> data, iWheelView<T> wheelView) {
        if (data != null) {
    ...
    @Override
    public void onItemSelected(iWheelView<T> wheelView, T data, int position) {
        if (isLinkage) {
            //联动
     ...
     * @return 选项1WheelView
     */
    public iWheelView<T> getOptionsWv1() {
        return mOptionsWv1;
    }
     ...
     * @return 选项2WheelView
     */
    public iWheelView<T> getOptionsWv2() {
        return mOptionsWv2;
    }
     ...
     * @return 选项3WheelView
     */
    public iWheelView<T> getOptionsWv3() {
        return mOptionsWv3;
    }
